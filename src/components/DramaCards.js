...
const dramaCards = [
  ...
  const handleShare = async (e, card) => {
    ...
    // window.location.origin বাদ দিয়ে সরাসরি আপনার মেইন ডোমেইন দেওয়া হলো
    ...
    if (navigator.share) {
      ...
      alert(
        "ড্রামার লিংক কপি করা হয়েছে! এখন আপনি এটি পেস্ট করে শেয়ার করতে পারেন।",
      );
    }
  };
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {dramaCards.map((card) => (
            <div
              key={card.id}
              className="bg-[#181818] rounded-lg overflow-hidden border border-gray-800 hover:border-gray-600 transition-colors group relative"
            >
